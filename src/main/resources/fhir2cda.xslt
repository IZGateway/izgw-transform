...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns:f="functions" exclude-result-prefixes="xs fhir cda">
            ...
            <patientRole>
                ...
                <patient classCode="PSN" determinerCode="INSTANCE">
                    ...
                    <xsl:if test="$raceExt[0]">
                        <raceCode
                            code="$raceExt[0]/fhir:extension[@url='ombCategory']/fhir:valueCoding/fhir:code/@value"
                            codeSystem="2.16.840.1.113883.6.238"
                            codeSystemName="CDC Race and Ethnicity">
                            <xsl:if
                                test="$raceExt[0]/fhir:extension[@url = 'ombCategory']/fhir:valueCoding/fhir:display/@value">
                                <xsl:attribute name="displayName"
                                    select="$raceExt[0]/fhir:extension[@url = 'ombCategory']/fhir:valueCoding/fhir:display/@value"
                                />
                            </xsl:if>
                        </raceCode>
                        <xsl:for-each
                            select="$raceExt[0]/fhir:extension[@url = 'detailed']/fhir:valueCoding">
                        ...
                        <xsl:for-each
                            select="$raceExt[position() > 0]/fhir:extension[@url = 'ombCategory' or @url = 'detailed']/fhir:valueCoding">
                            <sdtc:raceCode code="fhir:code/@value"
                                codeSystem="2.16.840.1.113883.6.238"
                                codeSystemName="CDC Race and Ethnicity">
                                <xsl:if test="fhir:display/@value">
                    ...
                    <xsl:if test="$ethnExt[0]">
                        <ethnicGroupCode
                            code="$ethnExt[0]/fhir:extension[@url='ombCategory']/fhir:valueCoding/fhir:code/@value"
                            codeSystem="2.16.840.1.113883.6.238"
                            codeSystemName="CDC Race and Ethnicity">
                            <xsl:if
                                test="$ethnExt[0]/fhir:extension[@url = 'ombCategory']/fhir:valueCoding/fhir:display/@value">
                                <xsl:attribute name="displayName"
                                    select="$ethnExt[0]/fhir:extension[@url = 'ombCategory']/fhir:valueCoding/fhir:display/@value"
                                />
                            </xsl:if>
                        </ethnicGroupCode>
    ...
    <xsl:function name="f:getPractitioner">
        ...
        <xsl:message><xsl:copy-of select="$ref"/></xsl:message>
