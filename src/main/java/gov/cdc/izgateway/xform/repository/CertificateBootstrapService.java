...
public class CertificateBootstrapService {

    private static final Logger logger = Logger.getLogger(CertificateBootstrapService.class.getName());
    ...
    public CertificateBootstrapService(@Autowired TrustManagerProvider trustManagerProvider) {
    ...
    private void updateTrustStore(X509Certificate certificate) throws Exception {
        ...
        // Reload the trust manager to use the updated trust store
        trustManagerProvider.reloadTrustStore();
