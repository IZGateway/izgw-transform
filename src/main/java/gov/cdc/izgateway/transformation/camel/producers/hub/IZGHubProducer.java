...
public class IZGHubProducer extends ProducerBase {
    ...
    private IDestination createDestination() throws UnknownDestinationFault {
        ...
        destinationIdObject.setDestId(getHubComponent().getDestinationId());
        destinationIdObject.setDestType(getHubComponent().getDestinationType());

        Destination destination = new Destination();
        destination.setDestUri(getHubComponent().getDestinationUri());
        destination.setDestId(getHubComponent().getDestinationId());
