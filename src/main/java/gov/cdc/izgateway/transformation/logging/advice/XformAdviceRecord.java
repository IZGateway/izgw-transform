 ...
 */
public record XformAdviceRecord(String className, String methodName, MethodDisposition methodDisposition, String descriptor,
                                String descriptorId, /* TODO @JsonIgnore */ String requestMessage, /* TODO @JsonIgnore */ String responseMessage, DataFlowDirection dataFlowDirection, boolean hasTransformed) {
